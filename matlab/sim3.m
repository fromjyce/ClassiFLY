...
% Add noise
noise = randn(size(doppler_signal)) * 0.01; % Adjust noise level as needed
...
nfft = 2^nextpow2(length(received_signal)); % Next power of 2 for zero-padding
...
window_size = 512; % Increase window size for better frequency resolution
overlap = 256; % Increase overlap to capture more detail
